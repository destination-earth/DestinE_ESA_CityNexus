...
import { ArrowRight, Trash } from '@kepler.gl/components/dist/common/icons';
import {
    CenterFlexbox,
    CustomPicker,
...
import {RemoveDatasetProps} from "@kepler.gl/components/dist/side-panel/common/types";
...
function CustomDatasetTitleFactory(
    ...
    return (
      <div className="custom-palette-panel" ref={root}>
        ...
        >
          ...
          {showDeleteDataset && datasetId.startsWith("prediction_") ? (
